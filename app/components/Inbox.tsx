...
function Inbox() {
  return (
    <section
      className="flex justify-center items-center h-fit bg-cover bg-center relative py-20 mb-4 bg-fixed  mt-24"
    ...
    >
      ...
      <div className=" relative z-10 p-4 flex justify-center items-center text-center gap-8">
        <div className="backdrop-blur px-8 py-8 rounded-xl">
          ...
          <p className="text-white text-center text-sm max-w-sm mt-2 ">
          ...
          <input
            ...
            type="text"
            className="bg-white w-40 text-sm px-2 border border-green-800 mt-4 py-2 rounded-lg lg:w-80 "
          />
